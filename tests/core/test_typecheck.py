...
#                 return {
#                 "x": NeuralType(("B",), ElementType()), "y": NeuralType(("B",), ElementType(), optional=True)
#                 }
#
#             @typecheck()
...
#             raise AssertionError
#         if result2.neural_type.compare(NeuralType(("B",),
#         CategoricalValuesType())) != NeuralTypeComparisonResult.SAME:
#             raise AssertionError
#
#     @pytest.mark.unit
