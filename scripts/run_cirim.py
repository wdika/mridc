...
def load_model(
    ...
    model = CIRIM(
        ...
        recurrent_filters=arguments.recurrent_filters,
        # size of kernel in each recurrent layer
        recurrent_kernels=arguments.recurrent_kernels,
        # dilation in each recurrent layer
        recurrent_dilations=arguments.recurrent_dilations,
        ...
        # number of top-level channels for sense est. U-Net
        sens_chans=arguments.sens_chans,
