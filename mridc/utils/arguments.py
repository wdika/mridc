...
def add_optimizer_args(
    ...
    parser.add_argument("--optimizer", type=str, default=optimizer,
                        help="Name of the optimizer. Defaults to Adam.")
...
def add_scheduler_args(parent_parser: ArgumentParser) -> ArgumentParser:
    ...
    parser.add_argument("--warmup_steps", type=int, required=False,
                        default=None, help="Number of warmup steps")
    parser.add_argument(
        "--warmup_ratio",
        type=float,
        required=False,
    ...
    parser.add_argument("--hold_steps", type=int, required=False,
                        default=None, help="Number of hold LR steps")
    parser.add_argument(
        "--hold_ratio",
        type=float,
        required=False,
    ...
    parser.add_argument("--min_lr", type=float, required=False,
                        default=0.0, help="Minimum learning rate")
    parser.add_argument(
