...
import mridc.collections.quantitative.data.qmri_loader as qmri_loader
...
from mridc.collections.common.models.base import BaseMRIModel, BaseSensitivityModel

__all__ = ["BaseqMRIReconstructionModel", "SignalForwardModel"]


class BaseqMRIReconstructionModel(BaseMRIModel, ABC):
    """
    ...
    def training_step(self, batch: Dict[float, torch.Tensor], batch_idx: int) -> Dict[str, torch.Tensor]:
        ...
        (R2star_map_init, S0_map_init, B0_map_init, phi_map_init, y, sampling_mask, r,) = self.process_inputs(  # type: ignore
            R2star_map_init,
            S0_map_init,
            B0_map_init,
            phi_map_init,
