...
import mridc.collections.multitask.rs.parts.transforms as transforms
...
from mridc.collections.common.models.base import BaseMRIModel, BaseSensitivityModel, DistributedMetricSum

__all__ = ["BaseMRIReconstructionSegmentationModel"]


class BaseMRIReconstructionSegmentationModel(BaseMRIModel, ABC):
    """
    ...
    def _setup_dataloader_from_config(cfg: DictConfig) -> DataLoader:
        ...
        dataset = mrirs_loader.RSMRIDataset(
            ...
            transform=transforms.RSMRIDataTransforms(
