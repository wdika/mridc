...
import mridc.collections.multitask.rs.models.idslr_base.idslr_block as idslr_block
...
class SegNet(base_rs_models.BaseMRIReconstructionSegmentationModel, ABC):
    """
