...
class SegmentationLambdaUNet(base_segmentation_models.BaseMRISegmentationModel, ABC):  # type: ignore
    """
    Implementation of the Lambda UNet for MRI segmentation, as presented in [1].
