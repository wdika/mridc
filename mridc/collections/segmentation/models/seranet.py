...
from mridc.collections.common.parts import center_crop_to_smallest, coil_combination
from mridc.collections.reconstruction.models.unet_base import unet_block
from mridc.collections.segmentation.models.attention_unet_base.attention_unet_block import AttentionGate
from mridc.collections.segmentation.models.seranet_base.convlstm_unet import ConvLSTMNormUnet
from mridc.collections.segmentation.models.seranet_base.recon_block import (
...
class SERANet(base_segmentation_models.BaseMRIJointReconstructionSegmentationModel, ABC):
    """
    Implementation of the End-to-End Recurrent Attention Network as presented in Huang, Q., et al.
    ...
    ..
         ...
         Huang, Q., Chen, X., Metaxas, D., Nadar, M.S. (2019). Brain Segmentation from k-Space with End-to-End
