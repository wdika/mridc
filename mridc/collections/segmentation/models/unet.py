...
class SegmentationUNet(base_segmentation_models.BaseMRIJointReconstructionSegmentationModel, ABC):
    """Implementation of the UNet as a module."""
    ...
    def forward(
        ...
        if self.consecutive_slices > 1:
            ...
            init_reconstruction_pred = init_reconstruction_pred.reshape(  # type: ignore
                # type: ignore
                init_reconstruction_pred.shape[0] * \
                init_reconstruction_pred.shape[1],
