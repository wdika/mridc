...
class ProcessLauncherConfig:
    _target_: str = "mridc.core.utils.process_launcher.launcher.ProcessLauncher"
    num_gpus: int = -1
    jobs_per_gpu: int = 1
            ...
            while sum(finished_processes) < len(subprocess_list):
                ...
                for proc_idx, proc in enumerate(subprocess_list):
                    ...
                    if retcode is not None:
                        ...
                        std_error_buffers[proc_idx] = error_data  # type: ignore
...
ConfigStore.instance().store(
    ...
    provider="mridc_process_launcher",
)
