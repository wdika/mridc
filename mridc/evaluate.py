...
from mridc import complex_mul, complex_conj
from mridc import ifft2c
from mridc.data.transforms import to_tensor, center_crop, tensor_to_complex_np
            ...
            with h5py.File(tgt_file, "r") as target, h5py.File(
                ...
                if arguments.sense_path is not None:
                    ...
                    if "data/brain/sensitivities_maps/flair" in str(arguments.sense_path).lower():
                        sense = sense.squeeze(1).permute(0, 3, 1, 2, 4)
